...
build custom native execution providers, pin `of_execution_core` and
`of_execution` to compatible `0.2.x` versions and use the matching `0.1.x`
algorithm/adapter companion releases while those traits mature.
