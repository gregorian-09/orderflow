...
def _prometheus_metrics(snapshot: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "# HELP orderflow_runtime_max_events_per_poll Configured runtime event drain limit, or 0 when disabled.",
        "# TYPE orderflow_runtime_max_events_per_poll gauge",
        f"orderflow_runtime_max_events_per_poll{{{labels}}} {_prom_number(metrics.get('max_events_per_poll', health.get('max_events_per_poll'))):g}",
