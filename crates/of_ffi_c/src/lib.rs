...
use of_core::{
    ...
    IntervalCandleSnapshot, SessionCandleSnapshot, Side, SignalState, SymbolId, TradePrint,
};
use of_runtime::{
...
fn format_interval_candle_snapshot(snap: &IntervalCandleSnapshot) -> String {
    format!(
