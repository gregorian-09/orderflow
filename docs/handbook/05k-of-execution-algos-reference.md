...
- `SpreadConfig`: hedge ratio and minimum edge threshold,
- `SpreadQuote`: executable buy and sell leg prices,
- `SpreadEstimate`: current edge, executable flag, and planned leg quantities,
- `SpreadDecision`: estimate plus optional buy/sell child plans,
- `SpreadPlanner`: deterministic two-leg planner.
