...
basket/spread, and market-making planning primitives. The crate deliberately
does not own sockets, adapters, risk gates, journals, or OMS state. Child
orders generated by this crate should still be submitted through `of_execution`.
