...
- `IdempotencyRegistry`
- `ExecutionReportSourceId`
- `ExecutionReportKey`
- `ExecutionReportDisposition`
- `ExecutionReportDedupMetrics`
- `ExecutionReportDedupError`
...
- `encode_order_mass_status_request(out, version, header, request)`
